...
| **OS integrations** (smartcard middleware, certificate stores, file-system pickers beyond simple upload, native messaging hosts) | Sandbox OS is not the user's OS |
